...
CocktailsStack.navigationOptions = {
	...
	tabBarIcon: ({ focused }) => (
		<TabBarIcon
			focused={focused}
			name={Platform.OS === 'ios' ? `ios-information-circle${focused ? '' : '-outline'}` : 'glass-tulip'}
...
SearchStack.navigationOptions = {
	...
	tabBarIcon: ({ focused }) => (
		<TabBarIcon
			focused={focused}
			name={Platform.OS === 'ios' ? `ios-information-circle${focused ? '' : '-outline'}` : 'search'}
			type=""
		/>
	),
};
...
NewCocktailStack.navigationOptions = {
	...
	tabBarIcon: ({ focused }) => (
		<TabBarIcon
			focused={focused}
			name={Platform.OS === 'ios' ? `ios-information-circle${focused ? '' : '-outline'}` : 'add'}
			type=""
		/>
	),
};
...
GamesStack.navigationOptions = {
	...
	tabBarIcon: ({ focused }) => (
		<TabBarIcon
			focused={focused}
			name={Platform.OS === 'ios' ? `ios-information-circle${focused ? '' : '-outline'}` : 'md-game-controller-b'}
			type="ionicon"
		/>
	),
};
